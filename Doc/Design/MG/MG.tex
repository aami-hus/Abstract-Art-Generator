...
\color{red}
\item[\refstepcounter{acnum} \actheacnum \label{acFonts}:] The list of fonts.\color{black}
\end{description}
...
\color{red}
\item [\refstepcounter{mnum} \mthemnum \label{mTO}:] Text Overlay Module
\item [\refstepcounter{mnum} \mthemnum \label{mST}:] Switch Theme Module\color{black}
\end{description}
